...
public class KPI {
    ...
    private static KPI parser(String line) {
        ...
        if (arr.length > 11) {
            ...
            arr[10] = arr[10].substring(0,arr[10].indexOf("?"));
    ...
    public static void main(String args[]) {
        ...
        System.out.println(line);
        KPI kpi = new KPI();
        kpi=KPI.filterPVs("114.112.141.6 - - [04/Jan/2012:00:00:04 +0800] \"GET /popwin_js.php?fid=6 HTTP/1.1\" 200 11 \"http://www.itpub.net/thread-1347509-1-1.html\" \"Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/5.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.3; .NET4.0C; .NET4.0E)\"");
